                        ...
                        <div class="d-flex flex-column h-100">
                            <div class="auth-content my-auto">
                                <div class="text-center">
                                    <h5 class="mb-0 sub-title">Client Forget Password</h5>
                                </div>
                                ...
                                <form class="mt-4 pt-2" action="{{ route('client.password_submit') }}"  method="post">
                                    ...
                                    <div class="mb-3">
                                        <button class="btn btn button-bg w-100 waves-effect waves-light" type="submit">EMAIL PASSWORD RESET LINK</button>
                                    </div>
                                </form>
