        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 sub-title font-size-18">Profile</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item bread-crumb"><a href="javascript: void(0);">Contacts</a></li>
                            <li class="breadcrumb-item bread-crumb active">Profile</li>
                        </ol>
                    </div>
...
<div class="row">
    <div class="col-lg-6">
        <div>
            ...
            <img id="showImage" src="{{ (!empty($profileData->cover_photo)) ? url('upload/client_images/'.$profileData->cover_photo) : url('upload/no_image.jpg') }}" alt="" class="p-1 button-bg" width="210" height="100">
    ...
    <div class="col-lg-6">
        <div class="mt-3 mt-lg-0">
            ...
            <div class="mb-3">
                ...
                <img id="showImage" src="{{ (!empty($profileData->photo)) ? url('upload/client_images/'.$profileData->photo) : url('upload/no_image.jpg') }}" alt="" class="rounded-circle p-1 button-bg" width="110">
            </div>
            <div class="mt-4">
                <button type="submit" class="btn button-bg waves-effect waves-light">Save Changes</button>
            </div>
