                        ...
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="mt-1">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted mt-2">Sign up to continue to Client.</p>
                                </div>
                                ...
                                <form class="mt-4 pt-2" action="{{ route('client.register.submit') }}"  method="post">
                                    @csrf
                                        ...
                                        <div class="mb-3">
                                            <button class="btn button-bg w-100 waves-effect waves-light" type="submit">Register</button>
                                        </div>
                                    </form>

                                    <div class="mt-5 text-center">
                                        <p class="text-muted mb-0">Do you have an account ?
                                            <a href="{{route('client.login')}}" class="small-title">
                                                Signin now
                                            </a>
                                        </p>
                                    </div>
